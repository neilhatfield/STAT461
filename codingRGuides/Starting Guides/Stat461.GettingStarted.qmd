...
If you have not already done so, you will need to install R. You can either search online for the link or you can use this [Download R from CRAN](https://cran.r-project.org/) link. __Be sure that you are using a recent version of R.__ That is, you need to have R be on version 4.5.0 or higher; at the time of writing, the current version of R is 4.5.2.
...
+ RStudio Desktop
  ...
  + [Download RStudio Desktop](https://posit.co/download/rstudio-desktop/)
    + Use the most recent version; at time of writing/revision, Version: 2026.08.2+200 
+ Visual Studio Code
...
+ Positron
  + This is a new-ish IDE built by the Posit PBC.
...
+ [Quarto Template](https://github.com/neilhatfield/STAT461/blob/main/hwTemplate_2024.qmd)--*Recommended*
...
+ Neil's [Quarto Crash Course](https://neilhatfield.github.io/STAT184/quarto_crash_course/)
