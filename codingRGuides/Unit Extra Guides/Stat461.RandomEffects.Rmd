...
If you were to use the random effects model output, you would get the following:

```{r anovaTab2, echo=TRUE}
parameters::model_parameters(
    model = loomRandom,
    omega_squared = "raw",
    eta_squared = "raw",
...
Notice how Table \ref{tab:anovaTab2} gives essentially nonsense. Stick with using the fixed effects model for reporting the ANOVA table.
