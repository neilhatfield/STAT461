...
4) Independence of Subjects
  - Each subject should be independent of one another
  - Observations across subjects should be independent (e.g., Subject A's first observation should have no impact on Subject B's first observation)
  - Observations within a subject will have a dependency.
...
An alternative approach to assessing homoscedasticity that is useful in Within Subjects Repeated Measures designs is a residual dot plot as shown in Figure \ref{fig:beerDot}.
