...
+ Visualizing Pairwise Differences
  ...
  - Box Plots
+ Extra--Post Hoc for the Nonparametic Shortcut
  - Dunn's Test
  - DSCF Test
  - Effect Sizes
...
For this guide/tutorial, we are going to make use of the __Free Amino Acids in Cheese__ (or the Cheese study). For information on the Cheese study, look at Table 5.2 and Example 5.5 from page 91 of Oehlert. You can also make use of the Spring 2022 Song Knowledge Study for the Your Turn examples.
