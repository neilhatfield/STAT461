...
The question of whether double stuf oreos are actually double the stuff, I guess, is a two sample location problem.

The null hypothesis would be \(2D = R\); while the alternative hypothesis would be 2D not equal R. I can reframe this as \(2D - R = 0\) vs \(2D - R \neq 0\). This would be a two-sample t test.
