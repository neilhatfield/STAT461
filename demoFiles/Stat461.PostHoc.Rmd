...
To access these functions, you'll need to enclude the following code in your R file. My recommendation is to stick this right next to where you set the sum to zero constraint. Both of them should be towards the top of your document, near where you have placed all of your library calls.
