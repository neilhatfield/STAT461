...
+ That the data is *real* and not simulated (i.e., fake).
...
With relatively few exceptions each person *must* complete this project in a group with at least one other person. Only in special circumstances (e.g., using this project as an Honor's Option project or part of the Master's thesis) will I consider allowing a person to work alone. If you feel that you have a special situation, you need to tell me as soon as possible.
...
We will use the following tentative due dates

+ GP #1: Friday, Sept. 25th, 2026
+ GP #2: Friday, Oct. 16th, 2026
+ GP #3: OPTIONAL, Friday, Dec. 4th, 2026
+ GP #4: Class Vote on exact date during Finals Week (Dec 14-18, 2026)
+ GP #5: Concurrent/After GP #4
...
Given these many hats, I end up in the position where I might need to remove a member from a team. Thus, I reserve the right to remove individuals from any team for the course group project, at any time. Depending on when that removal happens, I might reassign the removed individual(s) to another group, assign an alternative assignment, or score the student at Not Yet, Not Shown for all learning outcomes attached to the project. 
...
| Beer brand, glass angle | Foam (head) height|
| Species, curb location | Tree diameter |
| Gender, Political affiliation | Time spent gaming |